  ...
  return (
    <header className="bg-gray-900 text-white py-4 shadow-md header">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        {/* Logo */}
        <Link to="/profileCart" className="text-2xl font-bold">
        ...
        <nav className="space-x-4">
          <Link to="/profileCart" className="hover:text-black transform transition-transform duration-300 hover:scale-105">
            Home
          </Link>
          
          {/* Cart Icon with Item Count */}
          <Link to="/profileCart/cart" className="relative group">
